                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="{{ route('admin.products.index') }}" class="dropdown-item {{ request()->routeIs('admin.products.*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="{{ route('admin.orders.index') }}" class="dropdown-item {{ request()->routeIs('admin.orders.*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="{{ route('admin.reviews.index') }}" class="dropdown-item {{ request()->routeIs('admin.reviews.*') ? 'active' : '' }}">
